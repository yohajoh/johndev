...
export const PROJECTS_DATA = [
  {
    ...
    images: [
      ...
      "/projects/ecommerce/admin-dashboard.jpg",
      "/projects/ecommerce/checkout-flow.jpg",
      "/projects/ecommerce/mobile-view.jpg",
    ],
    featured: true,
    color: "primary",
    metrics: [
  ...
  },
  {
    ...
    images: [
      "/projects/ai-platform/ai-dashboard.jpg",
      "/projects/ai-platform/content-editor.jpg",
      "/projects/ai-platform/analytics.jpg",
      "/projects/ai-platform/templates.jpg",
      "/projects/ai-platform/team-collab.jpg",
    ],
    featured: true,
    color: "secondary",
    metrics: [
  ...
  },
  {
    ...
    images: [
      "/projects/dashboard/main-dashboard.jpg",
      "/projects/dashboard/data-visualization.jpg",
      "/projects/dashboard/custom-reports.jpg",
      "/projects/dashboard/real-time-alerts.jpg",
      "/projects/dashboard/admin-panel.jpg",
    ],
    featured: true,
    color: "accent",
    metrics: [
  ...
  },
  {
    ...
    images: [
      "/projects/fitness-app/home-screen.jpg",
      "/projects/fitness-app/workout-tracking.jpg",
      "/projects/fitness-app/nutrition-log.jpg",
      "/projects/fitness-app/progress-charts.jpg",
      "/projects/fitness-app/social-feed.jpg",
    ],
    featured: false,
    color: "primary",
    metrics: [
      { label: "Downloads", value: "100K+", icon: Phone },
  ...
  },
  {
    ...
    images: [
      "/projects/iot-system/dashboard-overview.jpg",
      "/projects/iot-system/device-control.jpg",
      "/projects/iot-system/automation-rules.jpg",
      "/projects/iot-system/energy-monitoring.jpg",
      "/projects/iot-system/mobile-app.jpg",
    ],
    featured: false,
    color: "secondary",
    metrics: [
      { label: "Device Types", value: "100+", icon: Home },
      { label: "Automations", value: "500+", icon: Zap },
      { label: "System Uptime", value: "99.99%", icon: Globe },
      { label: "Energy Saved", value: "30%", icon: BatteryCharging },
    ],
    stats: [
  ...
  },
  {
    ...
    images: [
      "/projects/ui-library/component-showcase.jpg",
      "/projects/ui-library/dark-mode.jpg",
      "/projects/ui-library/documentation.jpg",
      "/projects/ui-library/theme-builder.jpg",
      "/projects/ui-library/accessibility.jpg",
    ],
    featured: false,
    color: "accent",
    metrics: [
